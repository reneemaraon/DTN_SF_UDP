...
for i in 1; do
    ...
    # ./waf --run "dtn_sf_udp --seed=$new_seed --traceFile=$tracedir/newdst.tcl --logFile=$thisdir/ns-2.log --nodeNum=3 --duration=2734.0" > dtn.txt
    # ./waf --run "dtn_sf_udp --seed=$new_seed --traceFile=$tracedir/newdst.tcl --logFile=$thisdir/ns-2.log --nodeNum=3 --duration=1000.0" > dtn.txt
    # ./waf --run "dtn_sf_udp --seed=$new_seed --traceFile=$tracedir/newdst.tcl --logFile=$thisdir/ns-2.log --nodeNum=4 --duration=800.0" > dtn.txt
    ./waf --run "dtn_sf_udp --seed=$new_seed --traceFile=$tracedir/newdst.tcl --logFile=$thisdir/ns-2.log --nodeNum=3 --duration=800.0" > dtn.txt
